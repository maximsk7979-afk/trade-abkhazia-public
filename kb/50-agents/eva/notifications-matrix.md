...
6. ~~**ГД-чувствительность**: A1/A2 (закупочные цены) — ГД скрыт, сохранить fail-closed.~~
   **Снято 2026-07-08 (решение владельца):** ГД видит закупочную сторону целиком — `noGd`
   убран с оплат/сторно поставщикам и местной закупки, «Закупка завершена» и «Расходы рейса»
   приходят ГД (`{gd:true}`). Исключение **ops_manager** из «Закупка завершена» (2026-06-14)
   НЕ отменялось. Учесть при реализации notify-core.
